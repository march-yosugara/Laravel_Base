...
<div class="card group_card">
  ...
  <div class="row">
    ...
    <button type=“button” class="btn btn-outline-danger col-5 btn_remove" name='{{ $group->group_id }}'>Remove</button>
  </div>
</div>
@endforeach
...
<div class="card add_group">
  ...
  <button id="btn_add" type=“button” class="btn btn-info">Add</button>
</div>
@endif
<div class="card add_group">
