(function () {
  ...
  function createItem(item) {
    const div = [
      ...
      '      maxlength="100" placeholder="' + js_mes.ph_note_item_title + '" value="' + item.note_item_title + '">',
      ...
      '        maxlength="100" placeholder="' + js_mes.ph_str1 + '" value="' + item.str1 + '">',
      '      <input name="int_val1" type="number" class="form-control col-5 int"',
      '        placeholder="' + js_mes.ph_int_val1 + '" value="' + item.int_val1 + '">',
      '      <input name="unit1" type="text" class="form-control col-2"',
      '        maxlength="10" placeholder="' + js_mes.ph_unit1 + '" value="' + item.unit1 + '">',
      '    </div>',
      '    <div class="row item2">',
      '      <input name="str2" type="text" class="form-control col-5"',
      '        maxlength="100" placeholder="' + js_mes.ph_str2 + '" value="' + item.str2 + '">',
      '      <input name="int_val2" type="number" class="form-control col-5 int"',
      '        placeholder="' + js_mes.ph_int_val2 + '" value="' + item.int_val2 + '">',
      '      <input name="unit2" type="text" class="form-control col-2"',
      '        maxlength="10" placeholder="' + js_mes.ph_unit2 + '" value="' + item.unit2 + '">',
      '    </div>',
      '    <div class="row item_memo">',
      '      <textarea name="memo" type="text" class="form-control col-12" rows="2"',
      '        placeholder="' + js_mes.ph_memo + '">' + item.memo + '</textarea>',
      '    </div>',
      '  </div>',
      '</div>',
    ];
